...
<head runat="server">
    <title>Đăng nhập tài khoản BUS.com</title>
...
<body style="height: 307px">
	...
	<h1>Login</h1>
    	...
    	<input type="text" runat="server" id="txttk" name="u" placeholder="Username" required="required" />
        <input type="password" runat="server" id="txtmk" name="p" placeholder="Password" required="required" />
